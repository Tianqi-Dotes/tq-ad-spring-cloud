...
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '创意表' ROW_FORMAT = Dynamic;
...
-- Records of ad_plan
-- ----------------------------
INSERT INTO `ad_plan` VALUES (10, 1, 'nike推广', 1, '2020-04-08 03:19:19', '2020-04-24 00:19:31', '2020-04-01 00:00:00', '2020-04-04 00:00:00');
...
CREATE TABLE `ad_unit`  (
  ...
  `update_time` datetime(0) NOT NULL DEFAULT '1970-01-01 00:00:00' COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '推广单元表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ad_unit_district`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '推广单元地域 Feature' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ad_unit_it`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '推广单元兴趣 Feature' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ad_unit_keyword`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '推广单元关键词 Feature' ROW_FORMAT = Dynamic;
...
CREATE TABLE `creative_unit`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '创意和推广单元关联表' ROW_FORMAT = Dynamic;
